...
export const AllProposalsPage = () => {
  ...
  const stats = [
    ...
    { label: "Generating",      value: statsData?.generating ?? "—", icon: Zap,          color: "text-blue-500",   bg: "bg-blue-50 dark:bg-blue-500/10"   },
    { label: "In Review",       value: statsData?.review     ?? "—", icon: ClipboardList,color: "text-violet-500", bg: "bg-violet-50 dark:bg-violet-500/10"},
    { label: "Failed",          value: statsData?.failed     ?? "—", icon: XCircle,      color: "text-red-500",    bg: "bg-red-50 dark:bg-red-500/10"     },
  ];

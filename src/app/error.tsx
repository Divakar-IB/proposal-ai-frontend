  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-8 text-center">
        ...
        <p className="text-8xl font-bold bg-linear-to-r from-red-400 via-rose-500 to-red-600 bg-clip-text text-transparent leading-none mb-4">
          Error
        </p>
        ...
        {error.digest && (
          <p className="text-xs text-muted-foreground/60 font-mono bg-muted px-3 py-1.5 rounded-md mb-8">
